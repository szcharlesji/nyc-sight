...
class _Config:
    ...
    img_size:         int   = 640
    conf_thres:       float = 0.40   # YOLO base threshold — keep low to catch proximity objects
    class_conf_thres: float = 0.60   # extra gate for class-based (fast_moving / aerial) detections
    device:           int   = 0
